    ...
    <x-modal wire:model="showDetails" title="Audit Record Details" class="backdrop-blur">
        ...
        <div class="space-y-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                    <label class="label">
                        <span class="label-text font-semibold">Entity</span>
                    </label>
                    <div>
                ...
                <div>
                    <label class="label">
                        <span class="label-text font-semibold">Severity</span>
                    </label>
                    <x-badge
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                    <label class="label">
                        <span class="label-text font-semibold text-red-600">Previous Values</span>
                    </label>
                ...
                <div>
                    <label class="label">
                        <span class="label-text font-semibold text-green-600">New Values</span>
                    </label>
